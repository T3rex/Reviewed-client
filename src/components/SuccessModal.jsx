      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-lg mx-4 sm:mx-0 p-6 sm:p-10">
        ...
        <div className="flex flex-col items-center text-center space-y-5">
          ...
          <div className="flex gap-4 mt-4">
            ...
            <button
              onClick={handleClose}
              className="bg-gray-300 cursor-pointer dark:bg-gray-700 text-gray-900 dark:text-white px-5 py-2 rounded-md hover:bg-gray-400 dark:hover:bg-gray-600 transition"
            >
              Close
            </button>
          </div>
