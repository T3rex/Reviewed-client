            ...
            <div className="flex flex-col items-center text-center gap-5">
              ...
              <div className="w-full flex flex-col sm:flex-row gap-4 items-center justify-center">
                ...
                {(formConfig.collectionType === "Text only" ||
                  formConfig.collectionType === "Text and Video") && (
                  <button className="w-full max-w-7/10  px-4 py-2 rounded-lg cursor-pointer bg-blue-500 hover:bg-blue-600 text-white font-medium transition-all duration-300 flex items-center justify-center">
